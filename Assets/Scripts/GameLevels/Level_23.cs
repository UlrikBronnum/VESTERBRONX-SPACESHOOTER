...
public class Level_23 : LevelScript_Level {
	...
	public override void loadLevel( )
	{
		...
		int[] enemyTypeSelection = new int[12]{		1,2,3,1,0,3,1,1,2,3,2,2
		};
		
		spwnScr.setSpawnBase(levelNumber , howManyEnemies, enemyTypeSelection, 4f);
